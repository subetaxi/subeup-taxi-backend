        ...
        if (typeof req.session.userid != 'undefined') {
            ...
            Country.findOne({_id: mongoose.Types.ObjectId(selected_country)}, function (error, country) {
                ...
                City.findOne({_id: selected_city}, function (error, city) {
                    ...
                    Trip.aggregate([trip_condition, trip_filter, country_filter, city_filter, trip_group_condition, lookup, search, count], function (error, array) {
                        ...
                        if (error || array.length == 0) {
                            ...
                            Trip.aggregate([trip_condition, trip_filter, country_filter, city_filter, trip_group_condition, lookup, search, sort, skip, limit], function (error, array) {
                                ...
                                if (error || array.length == 0) {
                                    ...
                                    Trip.aggregate([trip_condition, trip_filter, country_filter, city_filter, trip_group_condition_total], function (error, trip_total) {
